...
import { System } from "@gx/gi/Gjs/Gjs.js";
...
function esbuild(
    ...
    const runner = Gio.File.new_for_uri(import.meta.url)
        .get_parent()!
        .resolve_relative_path("runner.js")
        .get_path()!;

    const esbuild = Gio.Subprocess.new(
        [
            esbuildHelperPath.get_path()!,
            runner,
            target.get_path()!,
            ...inputArgs,
        ],
